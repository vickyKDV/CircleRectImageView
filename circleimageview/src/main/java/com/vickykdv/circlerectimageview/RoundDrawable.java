...
public class RoundDrawable extends Drawable {
    ...
    public static Drawable fromDrawable(Drawable drawable) {
        if (drawable != null) {
            if (drawable instanceof RoundDrawable) {
                ...
                // loop through layers to and change to RoundDrawables if possible
                for (int i = 0; i < num; i++) {
     ...
     * @return the {@link RoundDrawable} for chaining.
     */
    public RoundDrawable setCornerRadius(@CornerView int corner, float radius) {
    ...
    public RoundDrawable setCornerRadius(float topLeft, float topRight, float bottomRight,
        ...
        mCornersRounded[CornerView.KIRI_ATAS] = topLeft > 0;
        mCornersRounded[CornerView.KANAN_ATAS] = topRight > 0;
        mCornersRounded[CornerView.KANAN_BAWAH] = bottomRight > 0;
        mCornersRounded[CornerView.KIRI_BAWAH] = bottomLeft > 0;
        return this;
    }
